...
const CustomAlertModal: React.FC<{
    ...
    const iconColor = isSuccess ? '#4BB543' : (isError ? '#FF6347' : '#FFA500'); // Default to orange for warnings
        ...
        >
            <View style={modalStyles.modalOverlay}>
                <View style={modalStyles.modalBox}>
                    <Ionicons name={iconName} size={40} color={iconColor} style={modalStyles.modalIcon} />
