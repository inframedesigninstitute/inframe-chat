        ...
        >
            <View style={modalStyles.modalOverlay}>
                <View style={modalStyles.modalBox}>
                    ...
                    <TouchableOpacity style={[modalStyles.modalButton, { backgroundColor: '#FF6347' }]} onPress={handleClose}>
...
const SuccessModal: React.FC<{
    ...
    return (
        ...
        >
            <View style={modalStyles.modalOverlay}>
                <View style={modalStyles.modalBox}>
                    <Ionicons name="checkmark-circle" size={40} color="#4BB543" style={modalStyles.modalIcon} />
                    <Text style={modalStyles.modalTitle}>{title}</Text>
                    <Text style={modalStyles.modalSubtitle}>{message}</Text>
                    <TouchableOpacity style={[modalStyles.modalButton, { backgroundColor: '#4BB543' }]} onPress={handleClose}>
                        <Text style={modalStyles.modalButtonText}>OK</Text>
                    </TouchableOpacity>
                </View>
            </View>
