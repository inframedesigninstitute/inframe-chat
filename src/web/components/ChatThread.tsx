              ...
              <View style={styles.attachmentContainer}>
                ...
                <View style={styles.attachmentGrid}>
                  ...
                  <View style={styles.attachmentRow}>
                    {/* Gallery */}
                    <TouchableOpacity style={styles.attachmentItem} onPress={ handleAIImages }>
...
cameraButton: {
  ...
  attachmentContainer: { backgroundColor: '#fff', padding: 20,   width:700, flex:0.5,borderRadius:50,
    alignSelf:"center" },
