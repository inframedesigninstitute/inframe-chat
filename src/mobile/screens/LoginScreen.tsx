...
const styles = StyleSheet.create({
  ...
  listItem: { marginHorizontal:0,padding: 20,top:29, borderBottomWidth: 1, borderColor: '#ccc',borderRadius:20,borderEndWidth:1, borderLeftWidth:1, borderRightWidth:1, borderTopWidth:1, },
