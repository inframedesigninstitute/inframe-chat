...
import QuizPollModal from "../components/QuizPollModal";
...
export default function ChatThread({
  ...
  const [messages, setMessages] = useState<Message[]>([
    ...
    { id: '2', text: 'I am good, thanks!', isSent: true, timestamp: '10:11', status: 'read' },
    { id: '3', text: 'Great 😊', isSent: false, timestamp: '10:12', status: 'read' },
  ]);
  ...
  const handleSendLocation = (coords: { latitude: number; longitude: number }) => {
    ...
    setLocationVisible(false); // Close modal after sending
  };
...
const styles = StyleSheet.create({
  ...
  textInput: { flex: 1, fontSize: 15, padding: 10, backgroundColor: '#f3f3f3', borderRadius: 20, textAlign: 'left', color: "#000", },
  ...
  attachmentContainer: {
    backgroundColor: '#fff', padding: 20, width: 700, flex: 0.5, borderRadius: 50,
    alignSelf: "center"
  },
